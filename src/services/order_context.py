...
class OrderContext:
    ...
    def to_prompt_context(self) -> str:
        ...
        lines.extend([
            ...
            "Listen to the call and verify the following were correctly captured:",
            "1. Customer name matches what was stated by the supporter",
            "2. Address details match what was provided",
            "3. Donation amount matches what was agreed",
            "4. Gift Aid declaration matches what was discussed (if applicable)",
            "5. Opt-in preferences match what the supporter stated",
            "",
            "If any captured data does NOT match what was discussed in the call,",
            "add a NEGATIVE score_impact with category 'Data_entry_accuracy' explaining the discrepancy.",
            "Include the incorrect value captured vs what was actually stated.",
        ])
